...
if __name__ == '__main__':
    ...
    input_path_img = 'input/screenshot.png'
    output_root = 'output'
    ...
    if is_ocr:
        ...
        text.text_detection(input_path_img, output_root, show=True, method='easyocr')
    ...
    if is_ip:
        ...
        if is_clf:
            ...
            classifier['Elements'] = CompDetCNN(cnn_type="cnn-rico",version="3.10")
